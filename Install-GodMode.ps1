...
.DESCRIPTION
    Creates a new folders and names it to transform it into the "GodMode" control panel. The shortcut is placed in the Public profile
    on the desktop of the machine so all users have access to it.
